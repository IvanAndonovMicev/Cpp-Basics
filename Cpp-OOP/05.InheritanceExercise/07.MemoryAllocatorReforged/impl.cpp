...
void printResult(const ErrorCode errorCode, const std::string& command) {
	...
	case ErrorCode::DOUBLE_FREE:
		ostr << "system crash prevented, will skip this deallocation"; break;
	case ErrorCode::ALLOCATE_DEALLOCATE_MISMATCH:
		ostr << "Warning allocate/deallocate mismatch, will skip this deallocation"; break;
	case ErrorCode::MEMORY_LEAK:
		ostr << "memory leak prevented, will not make allocation"; break;
	}
